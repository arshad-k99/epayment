      ...
      Register
               ...
               <section>
                  <div class="container customHeader">
                     ...
                     <div class="row">
                        <div class="col-md-8">
                           <p>Please fill in the below details for tax payment through (i) Net Banking (ii) Debit Card (iii) Over the Counter (iv) NEFT/RTGS (v) Payment Gateway for <a href="#">these banks</a></a></p>
                        </div>
                     </div>
                     <div _ngcontent-gwb-c34="" class="col-md-8 marRight">
                        <div _ngcontent-gwb-c34="" class=" d-flex justify-content-end pb-1 popupLabel floatLeft"><span _ngcontent-gwb-c34="" class="asterisk">*&nbsp;</span> Indicates the mandatory fields </div>
                     </div>
                     <div class="row">
                        <div class="col-md-8">
                           <div class="border bg-white p-3">
                              ...
                              <row>
                                 <p>Enter Mobile Number for OTP verification</p>
                              </row>
                              <row>
                                 <div class="col-md-6">
               ...
               <script>
                 $(document).ready(function () {
                     ...
                     $(' #pan_number_confirm').on('input', function() {
                       check_pan_number_confirm();
                       enable_submit_button()
                     });
                    
                    function check_pan_number(){

                        var pan_number = $("#pan_number").val();

                        var pan_numberError = $("#pan_numberError");
...
// (!panRegex.test(pan_number))
                    ...
                    function check_pan_number_confirm(){
                        ...
                        var pan_number_confirm = $("#pan_number_confirm").val();
                    ...
                    function enable_submit_button() {
                       ...
                       if (check_pan_number() && check_pan_number_confirm() && check_mobile_number()) {
