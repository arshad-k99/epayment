               ...
               <section>
                  <div class="container customHeader">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <div class="w-100 border">
                                 <div class="w-100  p-4 min-h">
                                    <div class="title-03">
                                       <h5>Pay Fee [Other Receipts (500)]</h5>
                                    </div>
                                    <p>Appeal Fee</p>
                                 </div>
                                 <div class="but-block px-4 py-2 d-flex flex-wrap justify-content-end">
                                    <a _ngcontent-gwb-c38="" class="largervf proceed" href=""> Proceed </a>
                                 </div>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="w-100 mb-5">
                        <div class="row">
                           <div class="col-md-4">
                              <div class="title-03 border-bottom mb-3 pb-1">
                                 <h4>Need Help?</h4>
                              </div>
                              <div class="w-100">
                                 <a href="#">What is Assessment year?</a>
                              </div>
                           </div>
                        </div>
                     </div>
