                     ...
                     <div class="row">
                        <div class="col-md-8">
                           <div class="border bg-white p-3">
                              <div class="row">
                                 <div class="col-md-6">
                                    <mat-label _ngcontent-gwb-c34="" class="inputLabel">Mobile OTP <span _ngcontent-gwb-c34="" class="asterisk">*</span></mat-label>
                                 </div>
                   ...
                   $(document).ready(function() {
                       $('.number-input').on('input', function() {
                           ...
                           if (currentLength >= maxLength) {
                               var nextInput = $(this).closest('li').next().find('input');
                       ...
                       function enable_submit_button() {
                          ...
                          var allFilled = true;
                           ...
                           $('#numberList .number-input').each(function() {
                               if ($(this).val().trim() === '') {
                                   allFilled = false;
                                   return false;
                               }
