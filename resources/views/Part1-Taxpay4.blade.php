                     ...
                     <div class="row">
                        <div class="col-md-8">
                           <div class="border bg-white p-3">
                              <div class="bg-blue-box p-b-margin d-flex mat-card">
                                 <img src="images/successIconRound24.svg" class="me-2">
                                 <p > You have successfully verified through mobile OTP. Click Continue to make a new payment.
                                 </p>
                              </div>
                              <div class="row mt-4">
                                 <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <p>Name<br>
                                       IXZ GXXXXL IXXXA PXXXXXE LXXXXXD
                                    </p>
                                 </div>
                              </div>
                           </div>
